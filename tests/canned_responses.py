...
_DAILY_SUMMARY_MARKER = "synthesize a set of papers into a short set of next actions"
_DAILY_SUMMARY_RESPONSE = '["Test the strongest method on your current benchmark this week.","Automate one repeated workflow step using the paper ideas.","Run a targeted ablation on the main claimed improvement."]'
